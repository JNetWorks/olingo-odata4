...
public class ODataJsonSerializer extends AbstractODataSerializer {
  ...
  @Override
  public SerializerStreamResult entityCollectionStreamed(ServiceMetadata metadata,
  ...
  protected void writeEntitySet(final ServiceMetadata metadata, final EdmEntityType entityType,
                                ...
                                final Set<String> ancestors, final JsonGenerator json) throws IOException,
          SerializerException {
  ...
  protected void writeEntity(final ServiceMetadata metadata, final EdmEntityType entityType, final Entity entity,
                             final ContextURL contextURL, final ExpandOption expand, final Integer toDepth,
  ...
  protected void writeProperties(final ServiceMetadata metadata, final EdmStructuredType type,
                                 ...
                                 final ExpandOption expand,
                                 final Set<List<String>> expandedPaths,
                                 final Integer toDepth, final Set<String> ancestors,
                                 final JsonGenerator json)
          throws IOException, SerializerException {
  ...
  private void writeNavigationProperties(
          final ServiceMetadata metadata, final EdmStructuredType type, final Linked linked,
  ...
  protected void writeProperty(final ServiceMetadata metadata,
                               ...
                               final LinkedList<String> path, final SelectOption select,
                               final Set<List<String>> selectedPaths,
                               final ExpandOption expand,
                               final Set<List<String>> expandedPaths,
                               final JsonGenerator json)
  ...
  public SerializerResult referenceCollection(final ServiceMetadata metadata, final EdmEntitySet edmEntitySet,
                                              final AbstractEntityCollection entityCollection,
                                              final ReferenceCollectionSerializerOptions options)
          throws SerializerException {
    OutputStream outputStream = null;
    SerializerException cachedException = null;
